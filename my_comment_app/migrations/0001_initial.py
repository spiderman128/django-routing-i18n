# Generated by Django 4.0 on 2023-02-14 06:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('localization', models.CharField(max_length=10)),
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_comments', to='auth.user', verbose_name='user')),
            ],
            options={
